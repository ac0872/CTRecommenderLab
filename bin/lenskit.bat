...
set CLASSPATH=%APP_HOME%\lib\dist-2.2.jar;%APP_HOME%\lib\slf4j-api-1.7.6.jar;%APP_HOME%\lib\annotations-2.0.1.jar;%APP_HOME%\lib\lenskit-cli-2.2.jar;%APP_HOME%\lib\lenskit-all-2.2.jar;%APP_HOME%\lib\argparse4j-0.4.4.jar;%APP_HOME%\lib\logback-classic-1.0.13.jar;%APP_HOME%\lib\jansi-1.8.jar;%APP_HOME%\lib\jul-to-slf4j-1.7.6.jar;%APP_HOME%\lib\lenskit-core-2.2.jar;%APP_HOME%\lib\lenskit-eval-2.2.jar;%APP_HOME%\lib\lenskit-knn-2.2.jar;%APP_HOME%\lib\lenskit-svd-2.2.jar;%APP_HOME%\lib\lenskit-predict-2.2.jar;%APP_HOME%\lib\lenskit-slopeone-2.2.jar;%APP_HOME%\lib\logback-core-1.0.13.jar;%APP_HOME%\lib\lenskit-api-2.2.jar;%APP_HOME%\lib\grapht-0.10.0.jar;%APP_HOME%\lib\guava-18.0.jar;%APP_HOME%\lib\vectorz-0.41.2.jar;%APP_HOME%\lib\commons-compress-1.8.jar;%APP_HOME%\lib\auto-service-1.0-rc2.jar;%APP_HOME%\lib\lenskit-groovy-2.2.jar;%APP_HOME%\lib\groovy-all-2.1.5.jar;%APP_HOME%\lib\joda-time-2.3.jar;%APP_HOME%\lib\commons-cli-1.2.jar;%APP_HOME%\lib\ant-1.8.4.jar;%APP_HOME%\lib\hamcrest-library-1.3.jar;%APP_HOME%\lib\lenskit-data-structures-2.2.jar;%APP_HOME%\lib\javax.inject-1.jar;%APP_HOME%\lib\jsr305-1.3.9.jar;%APP_HOME%\lib\edn-java-0.4.4.jar;%APP_HOME%\lib\randomz-0.3.0.jar;%APP_HOME%\lib\mathz-0.3.0.jar;%APP_HOME%\lib\xz-1.5.jar;%APP_HOME%\lib\auto-common-0.3.jar;%APP_HOME%\lib\ant-launcher-1.8.4.jar;%APP_HOME%\lib\hamcrest-core-1.3.jar;%APP_HOME%\lib\fastutil-6.6.1.jar;%APP_HOME%\lib\commons-lang3-3.3.jar
